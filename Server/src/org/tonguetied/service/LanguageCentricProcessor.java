...
public class LanguageCentricProcessor implements ExportDataPostProcessor {
     ...
     */
    public List<KeywordByLanguage> transformData(List<Translation> translations, DaoRepository daoRepository) {
        ...
        if (translations != null) {
            ...
            Country defaultCountry = daoRepository.getCountry(CountryCode.DEFAULT);
