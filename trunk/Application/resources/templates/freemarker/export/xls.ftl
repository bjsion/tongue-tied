...
<#list translations as translation>
    <#if keyword != translation.keyword.keyword>
        <#assign keyword = "${translation.keyword.keyword}">
        <#assign rowCounter = rowCounter + 2>
    </#if>
</#list>
<#assign rowCounter = rowCounter + (translations?size)+ 1 >
    <Worksheet ss:Name="Translations">
        <Table ss:ExpandedColumnCount="6" ss:ExpandedRowCount="${rowCounter}" x:FullColumns="1" x:FullRows="1">
            ...
            <#list translations as translation>
                <#assign newKeyword = "${translation.keyword.keyword}">
