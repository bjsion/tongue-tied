...
import org.tonguetied.service.AbstractServiceTest;


public class DaoRepositoryTest extends AbstractServiceTest {
    ...
    protected void onSetUpInTransaction() throws Exception {
        ...
        getDaoRepository().saveOrUpdate(singapore);
        getDaoRepository().saveOrUpdate(australia);
        getDaoRepository().saveOrUpdate(english);
        getDaoRepository().saveOrUpdate(chinese);
        getDaoRepository().saveOrUpdate(bundle);
        ...
        getDaoRepository().saveOrUpdate(keyword1);
        getDaoRepository().saveOrUpdate(keyword2);
        getDaoRepository().saveOrUpdate(keyword3);
        getDaoRepository().saveOrUpdate(keyword4);
    }
    ...
    public final void testFindTranslationsWithNoLanguage() {
        ...
        try {
            translations = 
                getDaoRepository().findTranslations(parameters);
        }
