...
INSERT INTO USER(username, password, firstname, lastname, enabled, email, accountNonExpired, accountNonLocked, credentialsNonExpired, optlock) 
    VALUES('admin', 'a4a88c0872bf652bb9ed803ece5fd6e82354838a9bf59ab4babb1dab322154e1', 'admin', 'admin', 1, 'none', 1, 1, 1, 0);
