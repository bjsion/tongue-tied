...
/**
 * This is abstraction on top the underlying import method. The purpose is to 
...
public abstract class Importer {
     ...
     * @param state the value of the {@link TranslationState} to set on 
     * imported {@link Translation}s. This should never be <code>null</code> as
    ...
    /**
     * Validates the {@link ImportParameters} to make sure that all criteria 
     * are met to avoid errors during the import. Can be overridden by 
     * implementing classes to add extra validation, or can override specific 
     ...
     * The {@link ImportException} may contain additional information as to why
     * the import failed  
     ...
     * the import failed  
     */
    protected void validate(final byte[] input, List<ImportErrorCode> errorCodes) 
        throws ImportException 
    {
